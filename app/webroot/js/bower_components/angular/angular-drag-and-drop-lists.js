...
angular.module('dndLists', [])
  ...
  .directive('dndList', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
    ...
    return function(scope, element, attr) {
      ...
      var placeholder = angular.element("<li class='dndPlaceholder' style='list-style-type: none;float:left'><div class='drag_drop_item' style='background-color:#000000;'></div></li>");
