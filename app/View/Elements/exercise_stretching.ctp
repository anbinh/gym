                    ...
                    <div class="exercise_box exercise_box_editor" ng-controller="VideoController">
                        <div class="box_program_vew">                           
                            ...
                            <div class="description">
                                <p><?php echo $exercises_list[$item['exercise_item'][0]['exercise_id']]['name'];?></p>
                            </div>
                            <div class="serie">
                                <p style="color:#c7c8c9; margin-right:10px; font-size:10pt;"><?php echo __('Set')?></p> 
                                ...
                                <p style="color:#bcbdbe; margin-right:10px; font-size:10pt;"><?php echo __('Repetitions')?></p> 
                        ...
                        <div class="box_program_vew">                           
                            ...
                            <div>
                                <div style="position:relative; padding-top:3px;">
                                    ...
                                    <div>
                                        <p style="color:#c7c8c9; margin:0px; line-height:1; font-size:10pt;"><?php echo __('Set')?></p> 
                                        <p style="font-size:15px; line-height: 1.2; margin:0;"> 10</p>
                                    </div>
                                    <div style="padding-top:5px;">
                                        <p style="color:#bcbdbe; margin:0px; line-height:1; font-size:10pt;"><?php echo __('Repetitions')?></p> 
