<div ng-model="model_temp" data-drop="true" jqyoui-droppable="{multiple:true, onDrop: 'dropCallback()', onOver: 'overCallback()', onOut: 'outCallback()'}" class="exercise_box" ng-if="item.mode == 1">
