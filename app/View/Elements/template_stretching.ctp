...
>
    <div class="box_program_vew">
        ...
        <div class="content_box_stretching">
            <div ng-model="model_temp1" ng-init="model_temp1.Exercise = item.exercise_item[0].Exercise" data-drop="true" jqyoui-droppable="{multiple:true, onDrop: 'dropCallback(model_temp1, $index, 2, 0)', onOver: 'overCallback()', onOut: 'outCallback()'}" class="content_box_img" ng-class="isEdit ? '' : 'none_border'" layout-align="center center" layout="column">
            ...
            <div ng-model="model_temp2" ng-init="model_temp2.Exercise = item.exercise_item[1].Exercise" data-drop="true" jqyoui-droppable="{multiple:true, onDrop: 'dropCallback(model_temp2, $index, 2, 1)', onOver: 'overCallback()', onOut: 'outCallback()'}" class="content_box_img" ng-class="isEdit ? '' : 'none_border'" layout-align="center center" layout="column">
            ...
            <div ng-model="model_temp3" ng-init="model_temp3.Exercise = item.exercise_item[2].Exercise" data-drop="true" jqyoui-droppable="{multiple:true, onDrop: 'dropCallback(model_temp3, $index, 2, 2)', onOver: 'overCallback()', onOut: 'outCallback()'}" class="content_box_img" ng-class="isEdit ? '' : 'none_border'" layout-align="center center" layout="column">
                ...
                <video ng-mouseover="hoverIn($event)" ng-mouseleave="hoverOut($event)" class="img-responsive" preload="none" src="{{model_temp3.Exercise.video}}" poster="{{model_temp3.Exercise != null ? model_temp3.Exercise.photo : isEdit ? '/img/images/drag_exercise.png' : ''}}" <="" video=""></video>
            </div>
            <div ng-model="model_temp4" ng-init="model_temp4.Exercise = item.exercise_item[3].Exercise" data-drop="true" jqyoui-droppable="{multiple:true, onDrop: 'dropCallback(model_temp4, $index, 2, 3)', onOver: 'overCallback()', onOut: 'outCallback()'}" class="content_box_img" ng-class="isEdit ? '' : 'none_border'" layout-align="center center" layout="column">
                ...
                <video ng-mouseover="hoverIn($event)" ng-mouseleave="hoverOut($event)" class="img-responsive" preload="none" src="{{model_temp4.Exercise.video}}" poster="{{model_temp4.Exercise != null ? model_temp4.Exercise.photo : isEdit ? '/img/images/drag_exercise.png' : ''}}" <="" video=""></video>
            </div>
        </div>
