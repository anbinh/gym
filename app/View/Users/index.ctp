<div layout="column" class="info_user">
	<div layout="row"  class="avatar">
		...
		<div layout="row" layout-align="start center" class="username">Jocelyn123</div>
	</div>
	<div layout="row" style="height:120px;">				
		<div style="padding:8px 0 0 180px;" flex>
			...
			<div class="fullname">Jocelyn Goyer</div>
			<div class="city">Montreal</div>
			<div class="language">English</div>
			<div class="edit_profile"><a href="#">Edit</a></div>			
		</div>
...
<div layout="row">
	...
	<div style="width:300px;"> 
			<p style="margin:5px;"><strong>Advertising</strong></p>
			<img src="/img/images/Ad_example.jpg"/>
	</div>
</div>
<div layout="row">
	<div flex>
		<div layout="row" layout-align="start center" style="height:40px; padding-left: 10px;"><p style="font-size:14px; margin:0;">FAVORITE EXERCICES</p></div>
